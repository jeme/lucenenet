...
namespace Lucene.Net.Facet.Taxonomy
{
    ...
    public class FacetLabel : IComparable<FacetLabel>
    {
        ...
        private FacetLabel(FacetLabel copyFrom, int prefixLen)
        {
            ...
            if (Debugging.AssertsEnabled) Debugging.Assert(prefixLen >= 0 && prefixLen <= copyFrom.Components.Length, "prefixLen cannot be negative nor larger than the given components' length: prefixLen={0} components.length={1}", prefixLen, copyFrom.Components.Length);
